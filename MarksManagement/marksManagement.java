...
for (Mark mark : marks) {
if (mark.getRollNo() == rollNo) {
if (subInd == 1) mark.setSWE(updateMark);
else if (subInd == 2) mark.setSNK(updateMark);
else mark.setEVS(updateMark);
...
if (m2.totalMark() == m1.totalMark()) return 0;
else if (m2.totalMark() > m1.totalMark()) return 1;
else return -1;
}
}
